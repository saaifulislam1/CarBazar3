...
<body>
    ...
    <section class="fullShow">
        <?php
        try {
            $conn = new PDO('mysql:host=127.0.0.1:3308;dbname=carbazar;', 'sajib', '1234');
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            //database code
            $sqlquerystring = "SELECT * FROM blog";
        ...
        ?>
                ...
                ?>
                    ...
                    <div class="box">
                        ...
                        <a href="updateform.php?id=<?php $id = $row['id'];
                                                    echo $id ?>" class="text">Update</a>
                        <a href="delete.php?id=<?php $id = $row['id'];
                                                echo $id ?>" class="text">Delete</a>
                    </div>
